...
<body class="mb-48">
    <nav class="flex justify-between items-center mb-4">
        <a href="index.html">
            <img src="images/logo.png" alt="" class="w-24 logo">
        </a>
    ...
    <section class="relative h-72 bg-laravel flex flex-col justify-center align-center text-center space-y-4 mb-4">
        ...
        <div class="z-10">
            ...
            <div>
                <a href="register.html" class="inline-block border-2 border-white text-white py-2 px-5 rounded-xl uppercase mt-2 hover:text-black hover:border-black">
    ...
    <footer class="fixed bottom-0 left-0 w-full flex item-center justify-start font-bold bg-laravel text-white h-24 mt-24 opacity-90 md:justify-center">
        ...
        <a href="create.html" class="absolute top=1/3 right-10 bg-black text-white pu-2 px-5">Post Job</a>
    </footer>
</body>
</html>